...
/**
 * The Cassandra Client multi pool interface. 
 * mainly method is :
 * getClient(key)  & releaseClient()
 * 
 * code like:
 * 
 * CassandraClient client = clientpool.getClient(key);
 * try{
 ...
 */
public interface CassandraClientMultiPool {
	 ...
	 */
	public CassandraClient getClient(String key) throws Exception, NoSuchElementException, IllegalStateException;;
